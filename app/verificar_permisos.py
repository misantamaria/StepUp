...
print(f"\nPermisos:")
print(f"  ✓ Puede crear preguntas: {ayudante.has_perm('boards.add_question')}")
print(f"  ✓ Puede editar preguntas: {ayudante.has_perm('boards.change_question')}")
print(f"  ✗ Puede eliminar preguntas: {ayudante.has_perm('boards.delete_question')}")
...
print(f"\nPermisos:")
print(f"  ✓ Puede crear preguntas: {profesor.has_perm('boards.add_question')}")
print(f"  ✓ Puede editar preguntas: {profesor.has_perm('boards.change_question')}")
print(f"  ✓ Puede eliminar preguntas: {profesor.has_perm('boards.delete_question')}")
...
print(f"  ✗ Puede crear preguntas: {alumno.has_perm('boards.add_question')}")
